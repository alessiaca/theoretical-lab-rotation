...
table = plt.table(cellText=[[f"{approach_percentage} %"], [f"{avoid_percentage} %"], [str(n_stim)]],
                      rowLabels=['Approach percentage', 'Avoid percentage', 'Total number of simulations'],
